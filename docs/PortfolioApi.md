...
api_instance = ib_web_api.PortfolioApi()
...
# create an instance of the API class
api_instance = ib_web_api.PortfolioApi()
body = ib_web_api.Body2() # Body2 | accounts info
...
> InlineResponse20014 portfolio_positions_conid_get(conid)
