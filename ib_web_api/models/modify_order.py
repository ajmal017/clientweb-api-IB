...
class ModifyOrder(object):
    ...
    def __init__(self, acct_id=None, conid=None, order_id=None, order_type=None, outside_rth=None, price=None, aux_price=None, side=None, listing_exchange=None, ticker=None, tif=None, quantity=None):  # noqa: E501
