...
class Trade(object):
    ...
    def __init__(self, execution_id=None, symbol=None, side=None, order_description=None, trade_time=None, trade_time_r=None, size=None, price=None, submitter=None, exchange=None, comission=None, net_amount=None, account=None, company_name=None, contract_description_1=None, sec_type=None, conidex=None, position=None, clearing_id=None, clearing_name=None):  # noqa: E501
